...
let About = (props) => {
  return (
    <div>
      ...
      <p className='text-center'>
        This app is open source under the MIT license and the code can be found at <a href='https://www.github.com/sgalizia/ReactWeather.git' target='_blank'>here</a> on GitHub. The original design was developed by <a href='https://github.com/andrewjmead' target='_blank'>Andrew Mead</a> and this app was built while following his course on React which can be found <a href='https://www.udemy.com/the-complete-react-web-app-developer-course/learn/v4/content' target='_blank'>here</a>.
      </p>
    </div>
  )
};
